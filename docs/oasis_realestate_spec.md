...
4. **Metrics**: 计算并记录本 Step 的成交量、均价等。
...
2.  **买方逻辑**: 除了“买得起”，什么驱动购买？
    - *假设*: 刚需（没有房必须买）？投资（预期未来涨价）？
3.  **贷款偿还**: 既然引入了贷款，是否需要每个 Step 扣除月供？如果现金不足会断供/法拍吗？
